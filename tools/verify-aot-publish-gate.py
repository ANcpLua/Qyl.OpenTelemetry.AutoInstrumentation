...
VENDOR_WARNED_DEMOS: dict[str, tuple[Approval, ...]] = {
    ...
    "Qyl.RealEfCoreDemo": (
        ...
        approved("IL3053", "Microsoft.EntityFrameworkCore", "Microsoft.EntityFrameworkCore", "10.0.11"),
        approved("IL2104", "Microsoft.EntityFrameworkCore.Relational", "Microsoft.EntityFrameworkCore.Relational", "10.0.11"),
        approved("IL3053", "Microsoft.EntityFrameworkCore.Relational", "Microsoft.EntityFrameworkCore.Relational", "10.0.11"),
        approved("IL2104", "Microsoft.EntityFrameworkCore.Sqlite", "Microsoft.EntityFrameworkCore.Sqlite.Core", "10.0.11"),
        approved("IL3053", "Microsoft.EntityFrameworkCore.Sqlite", "Microsoft.EntityFrameworkCore.Sqlite.Core", "10.0.11"),
        approved("IL3002", "Microsoft.EntityFrameworkCore.Sqlite", "Microsoft.EntityFrameworkCore.Sqlite.Core", "10.0.11", 3, "Microsoft.EntityFrameworkCore.Infrastructure.SpatialiteLoader.FindExtension()"),
        approved("IL3002", "Microsoft.Extensions.DependencyModel", "Microsoft.Extensions.DependencyModel", "10.0.11", marker="Microsoft.Extensions.DependencyModel.DependencyContext..cctor()"),
    ),
    "Qyl.RealGraphQlDemo": (
    ...
    "Qyl.RealMySqlDataDemo": (
        ...
        approved("IL2104", "System.Configuration.ConfigurationManager", "System.Configuration.ConfigurationManager", "10.0.8"),
    ),
    "Qyl.RealNServiceBusDemo": (
        approved("IL2104", "NServiceBus.Core", "NServiceBus", "10.2.8"),
        approved("IL3053", "NServiceBus.Core", "NServiceBus", "10.2.8"),
        approved("IL3000", "NServiceBus.Core", "NServiceBus", "10.2.8", 2, "NServiceBus.FileVersionRetriever."),
    ),
