...
metric.sql=True
log.ilogger=True
meters=Microsoft.AspNetCore.Components|System.Net.Http|Npgsql|Qyl.AutoInstrumentation.Database|NServiceBus.Core|OpenTelemetry.Instrumentation.Runtime|OpenTelemetry.Instrumentation.Process
ef.text=False
