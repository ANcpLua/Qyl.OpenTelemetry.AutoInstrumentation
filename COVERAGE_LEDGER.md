...
| **M12 (next phase)** | Remaining big-ticket items: CI pipeline (remote enforcement, vendor semconv .nupkg first) · breadth fan-out (§07 modules) · bytecode path (§T013, deepest) | per-milestone | per-milestone | **awaiting direction** |
