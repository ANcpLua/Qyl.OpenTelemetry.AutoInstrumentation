...
| **M10 Enforcement** | Turn conformance from observation into a GATE: `gate.sh --strict` fails when verdict=unknown > 0. Prove it FAILS on M9 (MCP, 2 unknown) and PASSES on M8 (GenAI, 0 unknown) | n/a (tooling) — drift becomes a CI-failable signal | n/a | **defined** |
| M11+ | defined only after M10 proven | — | — | locked |
