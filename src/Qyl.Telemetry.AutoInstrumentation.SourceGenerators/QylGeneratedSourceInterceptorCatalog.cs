...
public sealed partial class QylAutoInstrumentationGenerator
{
    ...
    private static ImmutableArray<InterceptorEmissionDescriptor> CreateGeneratedEmissionDescriptors()
        ...
        [
            ...
            new InterceptorEmissionDescriptor(InterceptorKind.KafkaProducer, new TraceInterceptorBodyDescriptor("KafkaProducer", "producer", RuntimeHelper: new TraceRuntimeHelperDescriptor("global::Qyl.Telemetry.AutoInstrumentation.GeneratedCode.QylInterceptedKafka", "StartProducerActivity", "RecordException", TraceStartActivityArgumentKind.KafkaProduceDestination))),
