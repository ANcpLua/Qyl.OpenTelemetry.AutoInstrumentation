...
internal static class InstrumentationContract
{
    ...
    [
        ...
        Signal(24, "signals.traces.WCFCLIENT", InstrumentationSignal.Traces, "WCFCLIENT", "OTEL_DOTNET_AUTO_TRACES_WCFCLIENT_INSTRUMENTATION_ENABLED", "WCF", "*", "source|bytecode", "WCF client tracing promise for source-visible client call-sites. NativeAOT mode must not rewrite service dispatch or third-party binary internals."),
