...
internal static class InstrumentationContract
{
    ...
    [
        ...
        Option(45, "instrumentation_options.OTEL_DOTNET_AUTO_ENTITYFRAMEWORKCORE_SET_DBSTATEMENT_FOR_TEXT", "OTEL_DOTNET_AUTO_ENTITYFRAMEWORKCORE_SET_DBSTATEMENT_FOR_TEXT", InstrumentationSignal.Traces, "ENTITYFRAMEWORKCORE", "Whether EF Core can emit db.statement for text commands.", "db.statement"),
        ...
        Option(47, "instrumentation_options.OTEL_DOTNET_AUTO_ORACLEMDA_SET_DBSTATEMENT_FOR_TEXT", "OTEL_DOTNET_AUTO_ORACLEMDA_SET_DBSTATEMENT_FOR_TEXT", InstrumentationSignal.Traces, "ORACLEMDA", "Whether Oracle MDA can emit db.statement for text commands.", "db.statement"),
        Option(48, "instrumentation_options.OTEL_DOTNET_AUTO_SQLCLIENT_SET_DBSTATEMENT_FOR_TEXT", "OTEL_DOTNET_AUTO_SQLCLIENT_SET_DBSTATEMENT_FOR_TEXT", InstrumentationSignal.Traces, "SQLCLIENT", "Whether SQL Client can emit db.statement for text commands.", "db.statement"),
