...
- Benchmarks and generator-output snapshots are separate quality gates still needed for a
  complete 100/100 score; this RFC only defines and gates the contribution substrate.
